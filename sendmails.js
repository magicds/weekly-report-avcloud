    ...
    switch (type) {
        case 'fri':
            content = `
                ...
                <p><a href="https://fe.epoint.com.cn/weeklyreport/" target="_black">https://fe.epoint.com.cn/weeklyreport/</a></p>
        ...
        case 'verify':
            content = `
                <p>${injectedData.name}:</p>
                <p>您好，<span style="color:#ea644a;">${injectedData.verifyUsername}</span>，已经注册进入周报系统。</p> <p><span style="color:#ea644a;">如果您确认 TA 是团队成员</span>，请及时点击下方链接通过其验证请求（验证通过的用户才能正常使用周报系统）。</p><p><a href="https://fe.epoint.com.cn/weeklyreport/#/main/verify" target="_black">https://fe.epoint.com.cn/weeklyreport/#/main/verify</a></p>
            `
            break;
        default:
            break;
